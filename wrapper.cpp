...
PYBIND11_MODULE(srm3d, m) {
    ...
    // m.def("create_srm3d", [](py::array_t<int> input_array, double g_val, double Q) {
    //     auto vector_image = numpy_to_vector(input_array);
    //     return new SRM3D(vector_image, g_val, Q);
    // }, py::return_value_policy::take_ownership, py::arg("image"), py::arg("g_val"), py::arg("Q"));
}
